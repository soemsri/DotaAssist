...
const CURATED_TALENTS: Record<string, HeroTalentConfig> = {
  antimage: {
    10: {
      left: { en: '+9 Strength (+180 HP)', th: '+9 Strength (+180 เลือด)', category: 'survivability' },
      right: { en: '+9 Attack Speed', th: '+9 ความเร็วโจมตี', category: 'damage' },
      defaultPick: 'right',
    ...
    15: {
      left: { en: '+0.6s Mana Void Stun Duration', th: '+0.6s ระยะเวลาสตั๊น Mana Void', category: 'utility' },
      right: { en: '-1s Blink Cooldown', th: '-1s คูลดาวน์ Blink', category: 'mobility' },
      defaultPick: 'right',
    ...
    20: {
      left: { en: '+200 Blink Cast Range', th: '+200 ระยะการร่าย Blink', category: 'mobility' },
      right: { en: 'Counterspell Barrier / Dispel', th: 'Counterspell บาเรียสะท้อน / Dispel', category: 'survivability' },
      defaultPick: 'left',
    ...
    25: {
      left: { en: '+20% Counterspell Magic Resist', th: '+20% ต้านทานเวท Counterspell', category: 'survivability' },
      right: { en: '-50s Mana Void Cooldown', th: '-50s คูลดาวน์ Mana Void', category: 'damage' },
      defaultPick: 'right',
  ...
  axe: {
    10: {
      left: { en: '+8 Armor', th: '+8 เกราะ', category: 'survivability' },
      right: { en: '+20 Movement Speed', th: '+20 ความเร็วเคลื่อนที่', category: 'mobility' },
      defaultPick: 'left',
    ...
    15: {
      left: { en: '+12% Battle Hunger Movement Speed', th: '+12% วิ่งเร็วจาก Battle Hunger', category: 'mobility' },
      right: { en: '+30 Berserker\'s Call Armor', th: '+30 เกราะช่วงกด Call', category: 'survivability' },
      defaultPick: 'right',
    ...
    20: {
      left: { en: '+150 Culling Blade Damage', th: '+150 ดาเมจ Culling Blade', category: 'damage' },
      right: { en: 'Attacks Procs Counter Helix', th: 'การโจมตีธรรมดามีโอกาสสับหมุน Helix', category: 'damage' },
      defaultPick: 'right',
    ...
    25: {
      left: { en: '+100 Berserker\'s Call AoE', th: '+100 รัศมี Berserker\'s Call', category: 'utility' },
      right: { en: 'Battle Hunger Pierces Debuff Immunity', th: 'Battle Hunger ทะลุ BKB', category: 'damage' },
      defaultPick: 'left',
  ...
  juggernaut: {
    10: {
      left: { en: '+5 All Stats (+100 HP)', th: '+5 สเตตัสรวม (+100 เลือด)', category: 'survivability' },
      right: { en: '+150 Blade Fury DPS', th: '+150 ดาเมจต่อวิ Blade Fury', category: 'damage' },
      defaultPick: 'right',
    ...
    15: {
      left: { en: '-20s Healing Ward Cooldown', th: '-20s คูลดาวน์ Healing Ward', category: 'utility' },
      right: { en: '+25 Attack Speed', th: '+25 ความเร็วโจมตี', category: 'damage' },
      defaultPick: 'right',
    ...
    20: {
      left: { en: '+150 Blade Fury Radius', th: '+150 รัศมี Blade Fury', category: 'damage' },
      right: { en: '+50% Blade Dance Lifesteal', th: '+50% ดูดเลือดติดคริ Blade Dance', category: 'survivability' },
      defaultPick: 'right',
    ...
    25: {
      left: { en: '+1s Omnislash Duration', th: '+1s ระยะเวลา Omnislash', category: 'damage' },
      right: { en: '+475 Health', th: '+475 เลือด', category: 'survivability' },
      defaultPick: 'left',
  ...
  crystal_maiden: {
    10: {
      left: { en: '+200 Health', th: '+200 เลือด', category: 'survivability' },
      right: { en: '+100 Crystal Nova Damage', th: '+100 ดาเมจ Crystal Nova', category: 'damage' },
      defaultPick: 'left',
    ...
    15: {
      ...
      right: { en: 'Frostbite grants 200 Barrier', th: 'Frostbite ได้รับเกราะ 200 Barrier', category: 'survivability' },
      defaultPick: 'left',
    ...
    20: {
      left: { en: '+50 Freezing Field Damage', th: '+50 ดาเมจ Freezing Field', category: 'damage' },
      right: { en: '+200 Attack Speed', th: '+200 ความเร็วโจมตี', category: 'damage' },
      defaultPick: 'left',
    ...
    25: {
      left: { en: '+1.25s Frostbite Duration', th: '+1.25s ระยะเวลา Frostbite', category: 'utility' },
      right: { en: '+240 Crystal Nova AoE', th: '+240 รัศมี Crystal Nova', category: 'utility' },
      defaultPick: 'left',
  ...
  lion: {
    10: {
      left: { en: '+60 Earth Spike Damage', th: '+60 ดาเมจ Earth Spike', category: 'damage' },
      right: { en: '+15 Movement Speed', th: '+15 ความเร็วเคลื่อนที่', category: 'mobility' },
      defaultPick: 'right',
    ...
    15: {
      left: { en: '+70 Mana Drain per second', th: '+70 ดูดมานาต่อวิ', category: 'utility' },
    ...
    20: {
      left: { en: 'Earth Spike Reflects Damage', th: 'Earth Spike สะท้อนดาเมจ', category: 'utility' },
      right: { en: '+20 Finger Damage per kill', th: '+20 ดาเมจ Finger ต่อคิล', category: 'damage' },
      defaultPick: 'right',
    ...
    25: {
      left: { en: '+800 Mana Drain Health Steal AoE', th: '+800 ดูดเลือด/มานาหมู่', category: 'survivability' },
      right: { en: '+2.5s Hex Duration', th: '+2.5s ระยะเวลา Hex', category: 'utility' },
      defaultPick: 'right',
  ...
  phantom_assassin: {
    10: {
      left: { en: '+0.5s Phantom Strike Duration', th: '+0.5s ระยะเวลา Phantom Strike', category: 'damage' },
      right: { en: '+150 Health', th: '+150 เลือด', category: 'survivability' },
      defaultPick: 'left',
    ...
    15: {
      left: { en: '+20% Blur Evasion', th: '+20% หลบหลีก Blur', category: 'survivability' },
      right: { en: '+25% Cleave', th: '+25% โจมตีกระจาย Cleave', category: 'damage' },
      defaultPick: 'left',
    ...
    20: {
      left: { en: '+25% Stifling Dagger Damage', th: '+25% ดาเมจมีด Stifling Dagger', category: 'damage' },
      right: { en: '+60 Phantom Strike Attack Speed', th: '+60 ความเร็วโจมตี Phantom Strike', category: 'damage' },
      defaultPick: 'right',
    ...
    25: {
      left: { en: '+7% Coup de Grace Chance', th: '+7% โอกาสติดคริ Coup de Grace', category: 'damage' },
      right: { en: 'Triple Stifling Dagger', th: 'ปามีด Stifling Dagger 3 แฉก', category: 'damage' },
      defaultPick: 'left',
